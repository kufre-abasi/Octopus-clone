  ...
  setup() {
    return {
      ...
      authorname: [
        {
          id: 1,
          name: "Smooth sailing if you’re shipping containers",
        },
      ],
    };
  },
...
Make any
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2  mt-0 sm:gap-20 ">
      <!-- About details -->
      ...
      <!-- About profile image -->
      <img
        src="@/assets/images/octupos/container-deployments-octopus-deploy.png"
