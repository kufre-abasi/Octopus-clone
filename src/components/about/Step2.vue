  ...
  setup() {
    return {
      ...
      authorname: [
        {
          id: 1,
          name: "The only release management tool your operations team can use too",
        },
      ],
    };
  },
...
Make any
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2  mt-5 sm:gap-20 ">
            <!-- About profile image -->
          <img
        src="@/assets/images/octupos/runbooks-3.png"
        class=" mt-0 sm:mb-0 "
        alt=""
      />
